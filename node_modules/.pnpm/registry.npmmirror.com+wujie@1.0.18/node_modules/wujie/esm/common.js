...
export var appWindowAddEventListenerEvents = ["hashchange", "popstate", "DOMContentLoaded", "load", "beforeunload", "unload", "message", "error", "unhandledrejection"]; // 子应用window.onXXX需要挂载到iframe沙箱上的事件
